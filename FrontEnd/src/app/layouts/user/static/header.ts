  ...
  template: `     <header class="border-b border-slate-200 bg-white/90">
        <nav class="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap items-center justify-center gap-2">
                <a href="posts.html" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-bold text-white">Posts</a>
                <a href="about-us.html" class="rounded-lg px-4 py-2 text-sm font-bold text-slate-700 hover:bg-slate-100">About us</a>
                <a href="contact-us.html" class="rounded-lg px-4 py-2 text-sm font-bold text-slate-700 hover:bg-slate-100">Contact us</a>
            </div>
        </nav>
    </header>`, 
  styles: ``,
